...
public class cube3D extends element3D implements Cloneable{
	...
	public void draw3Delement(Graphics[] g){
		...
		// draw the top square
		j3Dutils.draw3DLine(g,pt[0].x,pt[0].y,pt[0].z,pt[1].x,pt[1].y,pt[0].z,thick);
		j3Dutils.draw3DLine(g,pt[1].x,pt[1].y,pt[1].z,pt[2].x,pt[2].y,pt[2].z,thick);
		j3Dutils.draw3DLine(g,pt[2].x,pt[2].y,pt[2].z,pt[3].x,pt[3].y,pt[3].z,thick);
		j3Dutils.draw3DLine(g,pt[3].x,pt[3].y,pt[3].z,pt[0].x,pt[0].y,pt[0].z,thick);
		// draw the bottom square
		j3Dutils.draw3DLine(g,pt[4].x,pt[4].y,pt[4].z,pt[5].x,pt[5].y,pt[5].z,thick);
		j3Dutils.draw3DLine(g,pt[5].x,pt[5].y,pt[5].z,pt[6].x,pt[6].y,pt[6].z,thick);
		j3Dutils.draw3DLine(g,pt[6].x,pt[6].y,pt[6].z,pt[7].x,pt[7].y,pt[7].z,thick);
		j3Dutils.draw3DLine(g,pt[7].x,pt[7].y,pt[7].z,pt[4].x,pt[4].y,pt[4].z,thick);
		// draw the vertical lines
		j3Dutils.draw3DLine(g,pt[0].x,pt[0].y,pt[0].z,pt[4].x,pt[4].y,pt[4].z,thick);
		j3Dutils.draw3DLine(g,pt[1].x,pt[1].y,pt[1].z,pt[5].x,pt[5].y,pt[5].z,thick);
		j3Dutils.draw3DLine(g,pt[2].x,pt[2].y,pt[2].z,pt[6].x,pt[6].y,pt[6].z,thick);
		j3Dutils.draw3DLine(g,pt[3].x,pt[3].y,pt[3].z,pt[7].x,pt[7].y,pt[7].z,thick);
